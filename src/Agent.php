...
class Agent extends MobileDetect
{
    ...
    {
        return $this->retrieveUsingCacheOrResolve('session.platform', function () {
    ...
    {
        return $this->retrieveUsingCacheOrResolve('session.browser', function () {
            return $this->findDetectionRulesAgainstUserAgent(
    ...
    {
        return $this->retrieveUsingCacheOrResolve('session.desktop', function () {
